...
import { getTotalsTrier, LoginTrier } from "@/app/api/cartao/trier";
...
export function LoginFormTrier({
  startDate,
  endDate,
}: {
  startDate: string;
  ...
  const [showListTotals, setShowListTotals] = useState<boolean>(false);
