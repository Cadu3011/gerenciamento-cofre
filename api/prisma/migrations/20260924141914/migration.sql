-- CreateTable
CREATE TABLE `FatoCartaoParcelas` (
    ...
    INDEX `FatoCartaoParcelas_filialId_data_idx`(`filialId`, `data`),
    INDEX `FatoCartaoParcelas_data_adquirente_idx`(`data`, `adquirente`),
    UNIQUE INDEX `FatoCartaoParcelas_data_filialId_adquirente_bandeira_key`(`data`, `filialId`, `adquirente`, `bandeira`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- AddForeignKey
ALTER TABLE `FatoCartaoParcelas` ADD CONSTRAINT `FatoCartaoParcelas_filialId_fkey` FOREIGN KEY (`filialId`) REFERENCES `Filial`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
